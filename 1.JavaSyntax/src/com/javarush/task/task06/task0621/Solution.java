...
public static class Cat {
    ...
    @Override public String toString() {
        if ((mama == null) & (papa == null)) {  return "Cat name is " + name + ", no mother " + ", no father "; }
        else if (mama == null) return "Cat name is " + name + ", no mother " + ", father is " + papa.name;
        else if (papa == null) { return "Cat name is " + name + ", mother is " + mama.name + ", no father "; }
        else { return "Cat name is " + name + ", mother is " + mama.name + ", father is " + papa.name; }
    }
}
}